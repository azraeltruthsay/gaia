...
BASE_MODEL = "/gaia/gaia-instance/gaia-models/google/gemma-4-26B-A4B"
OUTPUT_DIR = Path("/gaia/GAIA_Project/artifacts/gemma_abliteration_pipeline")
...
ADAPTER_DIR = Path("/gaia/gaia-instance/gaia-models/lora_adapters/gemma-4-26b-sovereign-v1")
MERGED_MODEL_DIR = Path("/gaia/gaia-instance/gaia-models/prime-gemma-clean")
FINAL_MODEL_DIR = Path("/gaia/gaia-instance/gaia-models/prime-gemma-v1")  # Post-ROME final

# SAE config (Targeting Gemma 4 Text layers)
# Full attention layers in Gemma 4 26B: 5, 11, 17, 23, 29
SAE_LAYERS = [0, 5, 11, 17, 23, 29]
SAE_NUM_FEATURES = 16384  # Increased for 26B
SAE_EPOCHS = 50
SAE_SPARSITY = 0.01

# ROME config (Gemma 4 30-layer architecture)
ROME_LAYER = 23
ROME_CLAMP = 0.15  # Slightly more conservative for 26B
