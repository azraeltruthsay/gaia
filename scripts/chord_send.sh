...
# Pane mapping
CLAUDE_ALPHA_PANE="${CHORD_CLAUDE_ALPHA_PANE:-4}"
CLAUDE_BETA_PANE="${CHORD_CLAUDE_BETA_PANE:-3}"
GEMINI_ALPHA_PANE="${CHORD_GEMINI_ALPHA_PANE:-1}"
GEMINI_BETA_PANE="${CHORD_GEMINI_BETA_PANE:-2}"
