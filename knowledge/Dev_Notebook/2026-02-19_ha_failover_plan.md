...
**Revised by:** Azrael & Claude (Opus 4.6) — Rev 2: one-way session sync, graceful cognitive checkpoint, hybrid maintenance mode, eliminated merge-back complexity. Rev 3: explicit failover SLO, SIGTERM propagation verification, grace period headroom, proactive candidate health alerting.
